...
function renderThemes() {
  ...
  container.innerHTML = activeThemes.map(t => `
    <article class="theme-card">
      ...
      <div class="theme-body">
        ...
        <div class="theme-footer" style="padding-top: 14px; border-top: 1px solid var(--border-color);">
          <div class="theme-actions" style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; width: 100%;">
            <a href="${t.PreviewURL || '#'}" target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-sm" style="width: 100%; justify-content: center;">Preview</a>
            <button onclick="openOrderModalWithTheme('${t.Nama}')" class="btn btn-primary btn-sm" style="width: 100%; justify-content: center;">Pesan</button>
          </div>
        </div>
      </div>
    </article>
  ...
  // Update dropdown pilihan tema di modal pemesanan (hanya nama tema)
